...
from loginFunction import loginFunction, change_wlan0_mac

BASE_DIR = os.path.dirname(os.path.abspath(__file__))
STATUS_FILE = os.path.join(BASE_DIR, '/AutologinPy/status.json')
...
def AccountsCheckFunction():
    ...
    while attempted_count < max_attempts:
        ...
        # 调用登录
        res = loginFunction(target_phone, acc_detail['id'])
